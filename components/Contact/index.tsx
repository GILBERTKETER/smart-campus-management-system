...
function Contact() {
  return (
    ...
    Connect with Tom Mboya University
                ...
                <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">    At Tom Mboya University, we strive to provide you with the best support and resources. Please reach out for assistance.
        ...
        <div className="flex items-stretch justify-center">
            <div className="grid md:grid-cols-2">
                <div className="h-full pr-6">
                    ...
                    You can reach us at the following address: P.O. Box 210-60400, Homa Bay, Kenya. We warmly welcome your inquiries and look forward to connecting with you to assist you with any questions or support you may need. Your engagement is important to us, and we are here to help!                    </p>
                    <ul className="mb-6 md:mb-0">
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Visit us
                                </h3>
                                <p className="text-gray-600 dark:text-slate-400">Tom Mboya University</p>
                                <p className="text-gray-600 dark:text-slate-400">P.O. Box 210-60400, Homa Bay, Kenya</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">Mobile: +254 700 000 000</p>
                                <p className="text-gray-600 dark:text-slate-400">Mail: info@tmu.ac.ke</p>
